      ...
      <div className="max-w-md w-full space-y-8 text-center">
        <div>
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
            There was a problem with the authentication process. This could happen if:
          </p>
          <ul className="mt-4 text-sm text-gray-600 dark:text-gray-400 text-left list-disc list-inside space-y-1">
